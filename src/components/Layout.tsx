        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 h-20 sm:h-24 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <button 
              ...
              className="p-2.5 sm:p-3 bg-slate-100 text-slate-900 rounded-xl sm:rounded-2xl hover:bg-slate-200 transition-colors hidden sm:flex lg:hidden items-center justify-center border border-slate-200/50"
            >
              <Menu size={18} />
            </button>
          </div>
